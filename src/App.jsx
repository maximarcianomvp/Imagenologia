                    ...
                    <tbody>
                      {estudios.map((sol, idx) => (
                        ...
                        >
                          ...
                          <td style={{ padding: "8px 12px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0", overflow: "hidden", textOverflow: "ellipsis" }}>{sol.protocolo || "-"}</td>
                          <td style={{ padding: "8px 12px", textAlign: "center", color: "#4B5563", borderRight: "1px solid #E2E8F0", fontSize: "10px" }}>
