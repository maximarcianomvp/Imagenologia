...
function CensoView({ solicitudes, loading, token, onSelectSolicitud, adscritos, perfiles }) {
  ...
  // Agrupar por adscrito → servicio
  const groupedByAdscrito = {};
  ...
  list.forEach(sol => {
    ...
    if (!groupedByAdscrito[doctor]) groupedByAdscrito[doctor] = {};
    if (!groupedByAdscrito[doctor][servicio]) groupedByAdscrito[doctor][servicio] = [];
    
    groupedByAdscrito[doctor][servicio].push(sol);
  });
