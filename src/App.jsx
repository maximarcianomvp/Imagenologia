...
function ConsultaExternaForm({ token, perfil }) {
  ...
  const [servicio, setServicio] = useState("Ginecología");
    ...
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
        ...
        <FG label="Sub-tipo" optional>
          <input type="text" value={subTipo} onChange={e => setSubTipo(e.target.value)} placeholder="Ej: General, Mama" style={{ padding: "8px 12px", borderRadius: 6, border: "1px solid #D1D5DB", fontSize: 14, fontFamily: "inherit", width: "100%" }} />
        </FG>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
        ...
        <FG label="Prioridad">
          <select value={prioridad} onChange={e => setPrioridad(e.target.value)} style={{ padding: "8px 12px", borderRadius: 6, border: "1px solid #D1D5DB", fontSize: 14, fontFamily: "inherit", width: "100%" }}>
            <option>Rutina</option>
