        ...
        <div key={turno} style={{ marginBottom: "30px" }}>
          ...
          {Object.entries(groupedByTurnoAdscrito[turno]).map(([doctor, estudios], docIdx) => (
            <div key={doctor} style={{ border: "1px solid #CBD5E1", borderTop: docIdx === 0 ? "1px solid #CBD5E1" : "none", background: "#FFF" }}>
              {/* Header Adscrito */}
              <div style={{ background: "#F1F5F9", padding: "8px 20px", fontWeight: "600", fontSize: "12px", color: "#1E293B", borderBottom: "1px solid #E2E8F0" }}>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "11px", tableLayout: "fixed" }}>
                ...
                <tbody>
                  {estudios.map((sol, idx) => (
                    ...
                    >
                      <td style={{ padding: "8px 8px", textAlign: "center", fontWeight: "600", color: "#475569", borderRight: "1px solid #E2E8F0" }}>{sol.rowNum}</td>
                      ...
                      <td style={{ padding: "8px 8px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: "10px" }}>{(sol.servicio_solicitante || sol.servicio_otro || "-").toUpperCase()}</td>
                      <td style={{ padding: "8px 8px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: "10px" }}>{(sol.motivo_clinico || "-").toUpperCase()}</td>
                      <td style={{ padding: "8px 8px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: "10px" }}>{sol.tipo_estudio?.toUpperCase()}</td>
                      <td style={{ padding: "8px 8px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: "10px" }}>{(sol.protocolo || "-").toUpperCase()}</td>
                      <td style={{ padding: "8px 8px", textAlign: "center", color: "#4B5563", borderRight: "1px solid #E2E8F0" }}>
                      ...
                      <td style={{ padding: "8px 8px", textAlign: "left", color: "#4B5563", fontSize: "10px", overflow: "hidden", textOverflow: "ellipsis" }}>
