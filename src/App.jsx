    ...
    <div style={{ padding: "20px", maxWidth: 1600, margin: "0 auto", background: "#F8FAFC", minHeight: "100vh" }}>
        ...
        <button
          onClick={() => {
            ...
            let html = `<html xmlns:x="urn:schemas-microsoft-com:office:excel"><head><meta charset="UTF-8"><style>
              ...
              .turno { background: #1E40AF; color: #FFF; font-weight: bold; font-size: 13px; }
              .adscrito { background: #F1F5F9; color: #1E293B; font-weight: bold; }
              .hdr { background: #374151; color: #FFF; font-weight: bold; text-align: center; }
              .realizado { background: #DCFCE7; color: #16A34A; font-weight: bold; text-align: center; }
              .pendiente { background: #FEF3C7; color: #D97706; font-weight: bold; text-align: center; }
              .urgente { color: #DC2626; font-weight: bold; }
            </style></head><body><table>`;

            html += `<tr><td colspan="10" style="background:#1E40AF;color:#FFF;font-size:16px;font-weight:bold;text-align:center;padding:10px;">IMAGENOLOG\u00cdA - CENSO ${esc(fecha)}</td></tr>`;
      ...
      {turnosPresentes.map((turno, turnoIdx) => (
        <div key={turno} style={{ marginBottom: "30px" }}>
          {/* Header Turno */}
          <div style={{ background: "#DBEAFE", color: "#1E3A8A", padding: "14px 20px", borderRadius: "8px 8px 0 0", fontWeight: "bold", fontSize: "16px", marginBottom: "0px", letterSpacing: "0.5px" }}>
