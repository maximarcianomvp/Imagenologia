                    ...
                    <tbody>
                      {estudios.map((sol, idx) => (
                        ...
                        >
                          ...
                          <td style={{ padding: "8px 12px", textAlign: "left", fontWeight: "600", color: "#1E40AF", borderRight: "1px solid #E2E8F0" }}>{sol.nombre_paciente}</td>
                          ...
                          <td style={{ padding: "8px 12px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0", fontSize: "10px" }}>{sol.servicio_solicitante || sol.servicio_otro || "-"}</td>
                          <td style={{ padding: "8px 12px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0", fontSize: "10px" }}>{sol.motivo_clinico || "-"}</td>
                          <td style={{ padding: "8px 12px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0", fontSize: "10px" }}>{sol.tipo_estudio}</td>
                          <td style={{ padding: "8px 12px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0" }}>{sol.protocolo || "-"}</td>
                    ...
                    <tbody>
                      {estudios.map((sol, idx) => (
                        ...
                        >
                          ...
                          <td style={{ padding: "8px 8px", textAlign: "left", fontWeight: "600", color: "#1E40AF", borderRight: "1px solid #E2E8F0", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{sol.nombre_paciente}</td>
                          ...
                          <td style={{ padding: "8px 8px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{sol.servicio_solicitante || sol.servicio_otro || "-"}</td>
                          <td style={{ padding: "8px 8px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0", overflow: "hidden", textOverflow: "ellipsis" }}>{sol.motivo_clinico || "-"}</td>
                          <td style={{ padding: "8px 8px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0", overflow: "hidden", textOverflow: "ellipsis" }}>{sol.tipo_estudio}</td>
                          <td style={{ padding: "8px 8px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0" }}>{sol.protocolo || "-"}</td>
