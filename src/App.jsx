                    ...
                    <tbody>
                      {estudios.map((sol, idx) => (
                        ...
                        >
                          ...
                          <td style={{ padding: "8px 8px", textAlign: "left", fontWeight: "600", color: "#1E40AF", borderRight: "1px solid #E2E8F0" }}>{sol.nombre_paciente}</td>
                          <td style={{ padding: "8px 8px", textAlign: "center", color: "#4B5563", borderRight: "1px solid #E2E8F0" }}>{sol.sexo || "-"}</td>
                          <td style={{ padding: "8px 8px", textAlign: "center", color: "#4B5563", borderRight: "1px solid #E2E8F0" }}>{sol.edad || "-"}</td>
                          <td style={{ padding: "8px 8px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0", fontSize: "10px" }}>{sol.servicio_solicitante || sol.servicio_otro || "-"}</td>
                          <td style={{ padding: "8px 8px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0", fontSize: "10px" }}>{sol.motivo_clinico || "-"}</td>
                          <td style={{ padding: "8px 8px", textAlign: "left", color: "#4B5563", borderRight: "1px solid #E2E8F0", fontSize: "10px" }}>{sol.tipo_estudio}</td>
