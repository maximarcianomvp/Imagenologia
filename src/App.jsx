              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
                <div>
                  ...
                  <p style={{ margin: 0, fontSize: 12, color: "#6B7280" }}>
                    Por <span style={{ fontWeight: 600, color: "#374151" }}>{anuncio.usuario_nombre}</span> · {new Date(anuncio.created_at).toLocaleDateString("es-MX")}
                  </p>
                </div>
...
function AjustesView({ session }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      {/* Sección de anuncios - solo para jefe */}
      {perfil?.rol === "Jefe" && (
        <div style={cx.card}>
      ...
      {/* Limpieza de historial - solo para jefe */}
      {perfil?.rol === "Jefe" && (
        <div style={cx.card}>
