...
function PanelResidente({ session, onLogout }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F8FAFC" }}>
      ...
      {/* Header */}
      <div style={{ background: "#1E3A8A", padding: isMobile ? "10px 12px" : "12px 20px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: isMobile ? 8 : 0 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <span style={{ fontSize: 22 }}>🩻</span>
            <div>
              <p style={{ margin: 0, fontWeight: 700, fontSize: isMobile ? 13 : 15, color: "#fff" }}>Imagenología</p>
        ...
        <div style={{ display: "flex", gap: 6, overflowX: "auto", paddingBottom: 2, marginTop: isMobile ? 0 : 10 }}>
          {TABS.map(tab => (
