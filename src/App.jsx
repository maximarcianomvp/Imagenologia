...
function AjustesView({ session }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={cx.card}>
        <p style={{ margin: "0 0 16px", fontSize: 13, fontWeight: 700, color: "#DC2626", textTransform: "uppercase", letterSpacing: "0.06em" }}>🏥 Registrar Hospitalizado</p>
        <SolicitudEmergenciaForm token={token} perfil={perfil} adscritos={adscritos} />
      </div>
