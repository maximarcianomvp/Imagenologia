...
function PanelResidente({ session, onLogout }) {
  ...
  const { startISO: todayStart, endISO: todayEnd } = getJornadaRange(hoy);
        ...
        {view === "solicitudes" && (
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : "repeat(4,1fr)", gap: 10, marginBottom: 14 }}>
              {[["Hoy",todaySolsFiltered.length,"#111827"],["Pendientes",todaySolsFiltered.filter(s=>s.estado==="pendiente").length,"#92400E"],["En proceso",todaySolsFiltered.filter(s=>s.estado==="en_proceso").length,"#1E40AF"],["Realizados",todaySolsFiltered.filter(s=>s.estado==="realizado").length,"#065F46"]].map(([l,v,c]) => (
